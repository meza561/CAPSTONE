...
function convertCohereUsage(usage) {
  if (usage == null) {
    return {
      inputTokens: {
        total: void 0,
                ...
                if (pendingToolCall && !pendingToolCall.hasFinished) {
                  ...
                  controller.enqueue({
                    ...
                    input: JSON.stringify(
                      await (0, import_provider_utils3.parseJSON)({
...
var cohereUsageSchema = import_v43.z.looseObject({
  billed_units: import_v43.z.looseObject({
    input_tokens: import_v43.z.number(),
    output_tokens: import_v43.z.number()
  }).nullish(),
  tokens: import_v43.z.looseObject({
    input_tokens: import_v43.z.number(),
    output_tokens: import_v43.z.number()
  }),
