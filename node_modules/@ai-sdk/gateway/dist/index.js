    ...
    try {
      const {
        ...
        failedResponseHandler: (0, import_provider_utils9.createJsonErrorResponseHandler)({
          ...
          errorToMessage: (data) => {
            var _a12;
            return (_a12 = (0, import_provider_utils9.getErrorMessage)(data)) != null ? _a12 : "unknown error";
          }
        }),
      ...
      return {
        ...
        warnings: [...(_a11 = responseBody.warnings) != null ? _a11 : [], ...warnings]
      };
    } catch (error) {
...
// src/version.ts
var VERSION = true ? "3.0.196" : "0.0.0-test";
